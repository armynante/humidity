        ...
        case 'delete': {
            ...
            if (project.do_app_id !== '' && project.do_app_id !== undefined) {
                ...
                if (deleteDoRegistry) {
                    ...
                    const registry = process.env.DO_REGISTRY_NAME;
                    if (!registry) {
                        console.error('DO Registry name not found');
                    }
                    else {
                        const [, e] = await doService.deleteDoRegistryRepo(project.name, registry);
                        if (e) {
                            console.error(e);
                        }
                        else {
